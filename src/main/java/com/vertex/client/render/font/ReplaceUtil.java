...
public class ReplaceUtil {
    ...
    static {
        REPLACEMENT_MAP.put('⚡', "");
        REPLACEMENT_MAP.put('ဴ', "CUSTOM");
        REPLACEMENT_MAP.put('ူ', "HERO");
        REPLACEMENT_MAP.put('ဣ', "HALLOWEEN");
        REPLACEMENT_MAP.put('ါ', "GUARDIAN");
        REPLACEMENT_MAP.put('့', "KRATOS");
        REPLACEMENT_MAP.put('း', "SAKURA");
        REPLACEMENT_MAP.put('ာ', "OVERLORD");
        REPLACEMENT_MAP.put('ဢ', "PHANTOM");
        REPLACEMENT_MAP.put('ဦ', "PHOENIX");
        REPLACEMENT_MAP.put('ဥ', "SUMMER");
